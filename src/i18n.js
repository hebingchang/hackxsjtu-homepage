...
export default {
  cn: {
    ...
    schedule: [
      'event-lg|6/1|星期五',
      'span-prepare',
      'event-prepare|17:30|学生和企业签到',
      'span-prepare',
      'event-prepare|19:00|HACK×SJTU启动仪式',
      'span-prepare',
      'event-prepare|20:15|赛前通知',
      'span-prepare',
      'event-prepare|20:30|至电院4号楼',
      'span-prepare',
      'event-prepare|21:00|HACK×SJTU正式开始',
      'span-prepare',
      'event-prepare|21:00|自由组队',
      'span-prepare',
      'event-prepare|23:30|休息',
      'span-prepare',
      '---',
      'event-lg|6/2|星期六',
      'span-rest',
      'event-rest|7:30|早餐',
      'span-rest',
      'event-rest|10:30|项目开发',
      'span-rest',
      'event-rest|11:30|午餐',
      'span-rest',
      'event-rest|14:30|WeWork 沙龙',
      'span-rest',
      'event-rest|15:00|网易 沙龙',
      'span-rest',
      'event-rest|15:30|HTC Vive 沙龙',
      'span-rest',
      'event-rest|16:00|吉罗科技 沙龙',
      'span-rest',
      'event-rest|17:30|晚餐',
      'span-rest',
      ...
      'event-crazy|7:30|早餐',
      'span-crazy',
      'event-crazy|8:30|冲刺开发',
      'span-crazy',
      'event-crazy|11:00|项目提交deadline',
      'span-crazy',
      'event-crazy|11:00|午餐、学生展位搭设',
      'span-crazy',
      'event-crazy|12:00|学生项目展示',
      'span-crazy',
      'event-crazy|15:30|至微电子楼报告厅',
      'span-crazy',
      'event-crazy|16:00|终选项目展示与闭幕式',
      'span-crazy'
    ],
    ...
    faqTitles: [
      'HACK×SJTU 是什么活动？',
      '参加 HACK×SJTU 需要缴费吗？',
      'HACK×SJTU 的具体活动地址是在哪里？',
      '谁能够申请参加？',
      '申请信息将包含什么？',
      '如果我不知道如何编程怎么办？',
      '申请通过后，我们将如何组队？',
      '成功通过筛选后，我们需要带些什么东西参加比赛？',
      '参加 HACK×SJTU ，我可以赢得什么？',
      '如果有什么其他问题，我该怎么办？'
    ],
  ...
  en: {
    ...
    schedule: [
      ...
      'span-prepare',
      'event-prepare|19:00|Kickoff Ceremony',
      'span-prepare',
      'event-prepare|19:50|Rule Introduction',
      'span-prepare',
      'event-prepare|20:10|Sponsor Rewards',
      'span-prepare',
      'event-prepare|20:40|Prior Notice',
      'span-prepare',
      ...
      'span-rest',
      'event-rest|10:30|Salon & Hacking',
      'span-rest',
      'event-rest|11:30|Lunch',
      'span-rest',
      'event-rest|14:00|Salon & Hacking',
      'span-rest',
      'event-rest|17:30|Dinner',
      'span-rest',
      ...
      'span-crazy',
      'event-crazy|8:30|Hacking Time',
      'span-crazy',
      'event-crazy|11:00|Submission Deadline',
      'span-crazy',
      'event-crazy|11:00|Lunch & Prep',
      'span-crazy',
      'event-crazy|12:30|Exhibition',
      'span-crazy',
    ...
    faqTitles: [
      'What is HACK×SJTU?',
      'Does it cost anything to participate in HACK×SJTU ?',
      'Where exactly is HACK×SJTU hosting?',
      'Who can apply for HACK×SJTU?',
      ...
      'What should I bring during  HACK×SJTU ?',
      'What I can win at  HACK×SJTU ?',
      'What if I have other questions?'
    ],

    faqAnswers: [
      'HACK×SJTU is hosted by Shanghai Jiaotong University and created by Grape Tech (Shenzhen) LLC. This hackathon inspires students to focus on “learning by doing” and “working as a team”. Student developers could hack whatever their heart desire. You could develop across software, hardware, applications, games and any sorts of extension. Our goal is to encourage open-source technology expansion and provide hands-on learning experience for students to use APIs/SDKs.',
      'HACK×SJTU is free for all accepted students! We will take care of everything including a place to have a rest at night. In addition, we will provide transportations’ compensation for students from outside of Shanghai City to join the hackathon. Come and join us now!!!',
      'The major event site will be at Shanghai Jiaotong University. The address is No. 800 Dongchuan Road, Minhang District, Shanghai.',
      'HACK×SJTU will be available for any kinds of students to apply across China. After submitting your application, we will select the best student talents from the application pool to participate in HACK×SJTU. We firmly believe that Innovation is a combination of arts and sciences. We are looking for the best talents across different majors. No matter your major is in general arts, mathematics, engineering field, we welcome you to apply for  HACK×SJTU !',
